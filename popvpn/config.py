...
DEFAULTS: dict = {
    ...
    "security.drop_insecure": True,
    "security.drop_private_hosts": True,
    "security.drop_legacy_vmess": True,
    "security.drop_weak_credentials": True,
    "security.max_warnings": 2,
    "probe.mode": "tcp",
    "probe.workers": 128,
    "probe.timeout": 4.0,
    "probe.tls": False,
    "probe.max_endpoints": 12000,
    "probe.cache_ttl": 900,
    "probe.state_file": "state/probe_cache.json",
    "probe.drop_dead": True,
    "probe.require_verified": True,
